...
class QRSDetector {
    ...
    func detectPeaks(electrocardiogram: Electrocardiogram, algorithm: Algorithms) -> ElectrocardiogramResult {
    ...
    func detectPeaks(electrocardiogram: Electrocardiogram, configuration: Configuration) -> ElectrocardiogramResult {
